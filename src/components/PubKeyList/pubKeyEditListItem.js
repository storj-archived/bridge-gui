      ...
      <tr>
        ...
        <td>
          ...
          <button
            ...
            onClick   = {(e) => {e.preventDefault(); this.props.editRowItemSaveAction(this.props.rowItem, this.state.itemKey)}}>
            <span>Save</span>
          </button>
          <button
            className = "btn btn-link btn-sm pull-right"
            onClick   = {(e) => {e.preventDefault(); this.props.editRowItemCancelAction()}}>
            <span>Cancel</span>
          </button>
        </td>
      </tr>
