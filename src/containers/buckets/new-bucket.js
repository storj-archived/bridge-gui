            ...
            <div className="col-xs-12">
              ...
              <form>
                    ...
                    <div className="content">
                      <div className="form-group">
                        ...
                        <input type="text" className="form-control" name="name"
                               placeholder="Bucket Name" {...this.props.fields.name}/>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-xs-6">
                    <a href="#noop" onClick={this.props.handleSubmit(this.createBucket.bind(this))}
                       className="btn btn-block btn-green btn-create-bucket">Save Bucket</a>
                  </div>
                </div>
              </form>
